    ...
    <footer className="bg-gray-950 text-gray-400">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-sm text-gray-400">Get updates on AI tools, launches, and agency insights.</p>
            </div>
            <NewsletterForm />
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8">
          ...
          <div className="sm:col-span-2">
            <Link href="/" className="inline-flex items-center gap-2.5 mb-5">
              ...
              <span className="font-bold text-xl text-white tracking-tight">
                Bay<span className="text-blue-500">AI</span>
              </span>
            </Link>
            <p className="text-sm text-gray-400 leading-relaxed max-w-xs mb-6">
              We build intelligent digital products — from AI chatbots to full-stack web apps — that help modern businesses grow faster.
            </p>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-500">
          <p>&copy; {new Date().getFullYear()} BayAI Agency. All rights reserved.</p>
          <div className="flex items-center gap-1">
            <span>Made with</span>
            <svg className="w-4 h-4 text-red-500 mx-0.5" fill="currentColor" viewBox="0 0 24 24">
